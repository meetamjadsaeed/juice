        ...
        initialize: (silent = false) => {
            ...
            $containers.forEach(($container) => {
                ...
                switch (action) {
                    // Click
                    case ('click'):
                        // Add a click event handler to the custom password trigger to toggle a password and break the switch
                    ...
                    case ('hover'):
                        ...
                        // Add a mouse leave event handler to the custom password trigger to hide a password and break the switch
        ...
        destroy: (silent = false) => {
            ...
            $containers.forEach(($container) => {
                ...
                switch (action) {
                    // Click
                    case ('click'):
                        // Remove the click event handler from the custom password trigger and break the switch
                    ...
                    case ('hover'):
                        ...
                        // Remove the mouse leave event handler from the custom password trigger and break the switch
